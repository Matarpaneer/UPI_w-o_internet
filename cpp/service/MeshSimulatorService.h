...
class VirtualDevice {
public:
    VirtualDevice(const std::string& id, bool internet) : deviceId(id), hasInternet(internet) {}
...
public:
    ...
    void inject(const std::string& senderDeviceId, const model::MeshPacket& packet);
